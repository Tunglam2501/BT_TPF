...
class TrainingConfig:
    ...
    Flowchart (Fig. 6) convergence loop:
    - max_replacement_rounds: how many times "Train Mix Model" can repeat
    - convergence_threshold: |Δloss| below which model is declared converged (Y)
    - convergence_window: number of recent epochs to average |Δloss| over
    """
    optimizer: str = 'adam'
    activation: str = 'tanh'
    batch_size: int = 1024
